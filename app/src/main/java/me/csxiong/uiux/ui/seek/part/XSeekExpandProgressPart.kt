 ...
 */
class XSeekExpandProgressPart(parent: XSeekBar) : XSeekDrawPart(parent) {
...
//        "${rightHeight} -- ${barHeight} -- ${percent}".print("csx")
        ...
        progressPath.lineTo(right - rightHeight, parent.customHeight / 2f + barHeight / 2f)
        rightRectF.set(right - rightHeight, parent.customHeight / 2f - (rightHeight - barHeight / 2f), right, parent.customHeight / 2f + barHeight / 2f)
