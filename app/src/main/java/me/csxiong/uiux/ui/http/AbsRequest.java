...
public abstract class AbsRequest {
    ...
    public <T> void execute(@Nullable ResponseListener<T> responseListener) {
        ...
        Runnable executable = () -> {
            ...
            if (responseListener != null && responseListener.getClass().getGenericInterfaces().length > 0
                    && responseListener.getClass().getGenericInterfaces()[0] instanceof ParameterizedType) {
                ParameterizedType parameterizedType =
                        (ParameterizedType) responseListener.getClass().getGenericInterfaces()[0];
